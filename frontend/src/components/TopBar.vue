...
const ICONS = { home: 'home', music: 'music', views: 'viz', transcode: 'convert', resources: 'box', models: 'box', soundfonts: 'music', utau: 'utau', play: 'play2', lyrics: 'music', edit: 'edit', viz: 'viz', analyze: 'chart', score: 'score', transcribe: 'transcribe', convert: 'convert' };
...
function about() {
  getAppVersion().then(v => {
    app.alertDialog({ title: 'FuFumidi ' + v, msg: t('离线 MIDI 播放 / 编辑 / 转录 / 乐谱 / 分析工作站\n本地 Vue3 + Vite + TypeScript 重构版') });
  });
  menuOpen.value = false;
}
</script>
