...
const VIEW_ICONS = { home: 'home', music: 'music', views: 'viz', transcode: 'convert', resources: 'box', soundfonts: 'music', utau: 'utau', play: 'play2', lyrics: 'music', edit: 'edit', viz: 'viz', analyze: 'chart', score: 'score', transcribe: 'transcribe', convert: 'convert' };
