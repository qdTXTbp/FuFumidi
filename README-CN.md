...
当前版本线：**4.0.2**（[发布说明](https://github.com/qdTXTbp/FuFumidi/releases/tag/v4.0.2)）。

4.0.2 要点：曲目列表恢复批量管理（多选 / 全选后批量移到歌单、收藏、移除）；修复转录「节拍网格检测（Beat This!）」勾选后不生效的问题（引擎侧漏传开关，日志始终显示已关闭）。
