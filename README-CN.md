...
当前版本线：**3.2.8**（[发布说明](https://github.com/qdTXTbp/FuFumidi/releases/tag/v3.2.8)）。

3.2.8 要点：增量更新器改为「先写临时文件、哈希校验通过后原子替换」——更新中途断网/限速不再导致应用文件被截断损坏；若更新确实中断，重新运行更新器即可自愈，无需重装。
