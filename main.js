...
function gpuEnhanceRoot() { return path.join(app.getPath('userData'), 'fufumidi', 'gpu-enhancements'); }
function gpuEnhanceDir(kind) { return path.join(gpuEnhanceRoot(), kind || ''); }
function gpuEnhanceSite(kind) { return path.join(gpuEnhanceDir(kind), 'site-packages'); }
